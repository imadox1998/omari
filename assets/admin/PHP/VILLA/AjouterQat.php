<?php
    ...
    $sql = "insert into immeuble values ('', '$Ref', '$Titre', '$Prix' ,'$Bedrooms', '$Bathrooms','$Superficie','$Levels','$kitchen','$Dining','$Living','$AC','$Internet','$Parking','$Type','$adresse','$Statu','$idvideo','$filename')";
    $conn->exec($sql);
